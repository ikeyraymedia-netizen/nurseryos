...
const en = {
  ...
  loader: {
    ...
    addPlantsTitle: 'Add Plants to Order',
    addAnotherPlant: 'Add another plant',
    removeLine: 'Remove',
    savePlant: 'Save Plant to Order',
    savePlants: 'Save {{n}} Plants to Order',
    lineN: 'Line {{n}}',
    addAtLeastOne: 'Add at least one plant line.',
    plantNameRequiredLine: 'Plant name is required on {{line}}',
    sizeRequiredLine: 'Container size is required on {{line}}',
    qtyMinLine: 'Quantity must be at least 1 on {{line}}',
