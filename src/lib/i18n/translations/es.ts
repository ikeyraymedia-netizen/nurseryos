...
const es: TranslationDict = {
  ...
  loader: {
    ...
    changeCustomerHint: 'Puede cambiar este pedido a otro cliente en cualquier momento después de subirlo.',
    keepNameOnly: 'Solo nombre: {{name}}',
    ...
    addPlantsTitle: 'Agregar plantas al pedido',
    addAnotherPlant: 'Agregar otra planta',
    removeLine: 'Quitar',
    savePlant: 'Guardar planta al pedido',
    savePlants: 'Guardar {{n}} plantas al pedido',
    lineN: 'Línea {{n}}',
    addAtLeastOne: 'Agregue al menos una línea de planta.',
    plantNameRequiredLine: 'El nombre de la planta es obligatorio en {{line}}',
    sizeRequiredLine: 'El tamaño del contenedor es obligatorio en {{line}}',
    qtyMinLine: 'La cantidad debe ser al menos 1 en {{line}}',
